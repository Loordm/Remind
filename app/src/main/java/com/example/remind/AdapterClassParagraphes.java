...
public class AdapterClassParagraphes extends BaseAdapter{
    ...
    public AdapterClassParagraphes(Context context, ArrayList<String> table , String sharedFileName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.list_view_paragraphes, parent, false);
        // ************************************** Show data **************************************
        TextView description = convertView.findViewById(R.id.writeyourwork5);
