...
public class AdapterClassQuestions extends BaseAdapter{
    ...
    public AdapterClassQuestions(Context context, ArrayList<String> table , String sharedFileName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.list_view_questions, parent, false);
        // ************************************** Show data **************************************
        TextView description = convertView.findViewById(R.id.writeyourwork4);
