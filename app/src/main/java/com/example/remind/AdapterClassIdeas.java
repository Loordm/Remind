...
public class AdapterClassIdeas extends BaseAdapter{
    ...
    public AdapterClassIdeas(Context context, ArrayList<String> table , String sharedFileName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.list_view_ideas, parent, false);
        // ************************************** Show data **************************************
        TextView description = convertView.findViewById(R.id.writeyourwork3);
